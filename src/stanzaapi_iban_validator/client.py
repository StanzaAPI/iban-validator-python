...
class IbanValidatorClient:
    """Official zero-dependency client for Global IBAN, BIC/SWIFT & Bank Routing Validator API."""
    ...
    def __init__(
        ...
        self.tier = tier
        self.tool_url = "https://stanzaapi.com/tools/iban-validator"
    ...
    def _request(self, endpoint: str, method: str = "GET", body: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        headers = {
            ...
            "User-Agent": "stanzaapi-iban-validator-python/1.0.0"
        }
        if self.api_key:
